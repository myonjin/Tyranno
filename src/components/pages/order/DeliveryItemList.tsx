...
export default function DeliveryItemList() {
    ...
    //     "cartId": 23,
    //     "optionId": 2,
    //     "productName": "[푸마] 남여 웜셀 라운드넥 긴팔 티셔츠 1종 택일",
    //     "imageUrl": "https://sitem.ssgcdn.com/28/25/73/item/1000567732528_i1_1100.jpg",
    //     "totalPrice": 9900,
    //     "discount": 30,
    //     "count": 5,
    //     "isKeep": 99,
            ...
            <div className="bg-white rounded-xl m-4 mb-20">
                ...
                <div className="flex px-[16px] py-[15px]">
                    <div className="flex justify-between">
                        <Image
                            src={'https://sitem.ssgcdn.com/74/87/78/item/1000531788774_i1_140.jpg'}
                            alt="한우"
                            width={150}
                            height={150}
                ...
                <div className="flex px-[16px] py-[15px]">
                    <div className="flex justify-between">
                        <Image
                            src={'https://sitem.ssgcdn.com/98/64/67/item/1000036676498_i1_140.jpg'}
                            alt="치즈쁘띠"
                            width={150}
                            height={150}
                            style={{ width: '80px', height: '80px' }}
