...
const item: ItemType = {
    id: 11,
    thumbnailUrl: 'https://sitem.ssgcdn.com/31/71/12/item/1000533127131_i1_500.jpg',
    alt: '',
...
export default function ItemCard({ itemId }: ItemCardPropsType) {
    const discountPrice = item.discountRate !== 0 ? item.price * ((100 - item.discountRate) / 100) : item.price
    ...
    return (
        <div className={`flex flex-col pt-2 pb-5 w-full h-full`}>
            ...
            <div className="flex flex-row justify-end items-center">
                ...
                <button className="w-[28px] h-[28px]">
                    <svg width="20px" viewBox="0 0 24 24" focusable="false" name="CartIcon">
                        <rect x="6" y="8.40002" width="14.4" height="1.2" fill="currentColor"></rect>
                        <path
                            fillRule="evenodd"
                            clipRule="evenodd"
            ...
            <div className="w-full">
                {item.discountRate !== 0 && <span className="text-xs line-through">{originalPrice}원</span>}
                ...
                {item.star && item.totalReviews && (
                    <div className="flex flex-row gap-1 text-xs">
                        <svg width={11} viewBox="0 0 11 16" focusable="false" name="StarFill">
                            <path
                                fill="#CFCFCF"
