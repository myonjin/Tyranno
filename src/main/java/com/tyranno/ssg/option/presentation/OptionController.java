...
public class OptionController {
    ...
    public ResponseEntity<?> findOptions(@Parameter(description = "상품 ID") @PathVariable(value = "product_id") Long productId) {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "선택 가능 옵션 조회 완료"),
            @ApiResponse(responseCode = "400", description = "선택 가능 옵션 조회 중 오류 발생")})
    public ResponseEntity<?> findOptionsList(@Parameter(description = "상품 ID") @PathVariable(value = "product_id") Long productId) {
