...
public class QCategory extends EntityPathBase<Category> {
    ...
    private static final long serialVersionUID = -385672513L;
    ...
    public final NumberPath<Long> largeId = createNumber("largeId", Long.class);

    public final NumberPath<Long> middleId = createNumber("middleId", Long.class);

    public final com.tyranno.ssg.product.domain.QProduct product;

    public final NumberPath<Long> smallId = createNumber("smallId", Long.class);
